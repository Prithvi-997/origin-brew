...
const layoutMetadata: Record<string, { slots: number; orientations: ("landscape" | "portrait" | "square")[] }> = {
  "layout8.svg": { slots: 5, orientations: ["landscape", "landscape", "portrait", "portrait", "portrait"] },
  "layout9.svg": { slots: 5, orientations: ["landscape", "landscape", "landscape", "landscape", "landscape"] },
  "layout10.svg": { slots: 5, orientations: ["landscape", "landscape", "landscape", "landscape", "landscape"] },
  "layout11.svg": { slots: 4, orientations: ["square", "square", "landscape", "landscape"] },
  "layout12.svg": { slots: 5, orientations: ["portrait", "portrait", "portrait", "landscape", "landscape"] },
  "layout13.svg": { slots: 4, orientations: ["square", "square", "square", "square"] },
  "layout14.svg": { slots: 4, orientations: ["portrait", "square", "square", "square"] },
  "layout15.svg": { slots: 5, orientations: ["square", "landscape", "landscape", "landscape", "landscape"] },
  "layout16.svg": { slots: 5, orientations: ["landscape", "portrait", "portrait", "portrait", "landscape"] },
  "layout17.svg": {
    slots: 6,
    orientations: ["landscape", "landscape", "landscape", "landscape", "square", "square"],
  },
  "layout18.svg": { slots: 6, orientations: ["portrait", "portrait", "portrait", "landscape", "portrait", "portrait"] },
  ...
  "layout22.svg": { slots: 3, orientations: ["portrait", "portrait", "portrait"] },
  "layout23.svg": { slots: 3, orientations: ["portrait", "portrait", "portrait"] },
  "layout24.svg": { slots: 3, orientations: ["portrait", "portrait", "portrait"] },
}
...
function findBestLayout(photos: Photo[]): string {
  ...
  if (!availableLayouts || availableLayouts.length === 0) {
    const closestCount = Object.keys(layoutsByFrameCount)
      .map(Number)
      .reduce((prev, curr) => (Math.abs(curr - frameCount) < Math.abs(prev - frameCount) ? curr : prev))
  ...
  for (const layoutName of availableLayouts) {
    ...
    for (let i = 0; i < Math.min(photoOrientations.length, layoutOrientations.length); i++) {
      if (photoOrientations[i] === layoutOrientations[i]) {
        score += 2
      } else if (
        (photoOrientations[i] === "square" && layoutOrientations[i] !== "square") ||
        (photoOrientations[i] !== "square" && layoutOrientations[i] === "square")
      ) {
        score += 1
      }
  ...
  console.log("[v0] Selected layout:", bestLayout, "for", frameCount, "photos with score:", bestScore)
  return bestLayout
}
